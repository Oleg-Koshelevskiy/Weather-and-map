const languagePack = [
  ...
  [
    "eng",
    {
      ...
      infoLi2:
        "Favorite locations - posibility to form a list of favorite cities for fast access to weather forecast",
      infoLi3: "Weather request according to current coordinates",
      infoLi4: "Weather request according to input city name",
      infoLi5:
